// src/sections/ExperienceStack.jsx
...
export default function ExperienceStack() {
  ...
  return (
    <section id="experience" className="about-section" aria-label="Experience" style={{ minHeight: '600vh', paddingTop: '200px', paddingBottom: '200px' }}>
      <div className="about-container" ref={containerRef}>
        <div className="about-header" style={{ marginBottom: '150px' }}>
          <h2 className="about-title" ref={titleRef}>experience</h2>
        </div>
